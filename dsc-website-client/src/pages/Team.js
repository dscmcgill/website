        ...
        <Grid container item xs={12} spacing={3} className="team">
          ...
          <Grid xs={4} item justify="left" className={classes.individual} direction="row">
            ...
            <Grid item container s={6}>
              <Typography className={classes.description}>
                Pulasthi is a second year EE student with interests in embedded systems
                design and full stack development. He loves cheesecake, speaks at 40 Hz at times, and enjoys
