...
function Team() {
  ...
  return (
    ...
    >
      ...
      <Grid container item xs={12} spacing={3} style={{ backgroundPosition: 'center', backgroundSize: 'cover', backgroundRepeat: 'no-repeat', backgroundImage: `url(${squares})`, }}>
        ...
        <Grid xs={4} item container justify="center" className={classes.individual} direction="row">
          <Grid className = {classes.box} item container justify="center" direction="row">
            <Grid item xs={6}>
              <img src="data:image/jpeg;base64," circle className={classes.profile_pic}/>
            </Grid>
            <Grid item xs={6} className={classes.name_pos} >
        ...
        <Grid item xs={12}>
            <Typography className={classes.not_lead} >
              Not Leads (Sub-Humans) (Not sure what background to put)
            </Typography>
        </Grid>
        ...
        <Grid xs={4} item justify="left" className={classes.individual} direction="row">
          ...
          <Grid item container s={6}>
          <Typography className={classes.description}>
          Pulasthi is a second year Electrical Engineering student with interests in embedded systems 
          design and full stack development. He loves cheesecake, speaks at 40 Hz sometimes, and enjoys 
